...
pub fn cross_origin_layer() -> impl tower::Layer<
    routing::Route,
...
{
    routing::get_service(tower_http::services::ServeDir::new(directory).fallback(fallback))
        ...
        .layer(middleware::from_fn(
            |path: axum::http::uri::Uri, req: extract::Request, next: middleware::Next| async move {
...
pub fn make_trace_layer() -> impl tower::Layer<
    routing::Route,
    Service = impl tower::Service<
        axum::http::Request<axum::body::Body>,
        Response = impl axum::response::IntoResponse,
